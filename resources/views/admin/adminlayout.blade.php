            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="{{ Auth::user()->profile_photo_path ? asset('assets/images/admin/'.Auth::user()->profile_photo_path) : asset('assets/images/people.png') }}" alt="">
