                    ...
                    <form class="forms-sample" action="{{ asset('/menu/edit/process/'.$product->id) }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="session" id="exampleSelectGender">
                          <option value="0" @php if($product->session=="0"){ echo"selected"; }   @endphp>Desayuno</option>
                          <option value="1" @php if($product->session=="1"){ echo"selected"; }   @endphp>Comida</option>
                          <option value="2" @php if($product->session=="2"){ echo"selected"; }   @endphp>Cena</option>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="available" id="exampleSelectGender">
                          <option @php if($product->available=="Stock"){ echo"selected"; }   @endphp>En existencia</option>
                          <option @php if($product->available=="Out Of Stock"){ echo"selected"; }   @endphp>Fuera de existencia</option>
